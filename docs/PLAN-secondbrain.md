...
- Vault bootstrap activation: if missing → clone remote; if clone fails → scaffold structure (index.md, daily/, projects/, decisions/, knowledge/, people/) + git init. Idempotent, non-destructive.
